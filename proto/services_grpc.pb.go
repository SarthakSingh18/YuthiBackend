...
func (c *mailServiceClient) SendMail(ctx context.Context, in *Mail, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/mailService/sendMail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMailServiceServer) SendMail(context.Context, *Mail) (*emptypb.Empty, error) {
...
func RegisterMailServiceServer(s grpc.ServiceRegistrar, srv services.AuthServer) {
...
func _MailService_SendMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mailService/sendMail",
	}
